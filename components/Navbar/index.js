...
import { MainContainer, ContentContainer, LeftSubContainer, HideAnimationContainer, RightSubContainer } from "./Styles"
...
import { useEscapeButtonListener, useShowCartModalOnCartUpdate } from "@/shared/hooks"
...
const Navbar = () => {
  ...
  return (
    <MainContainer>
      <ContentContainer>
        <LeftSubContainer>
          <Title2 style={{ cursor: "pointer" }} onClick={handleGoToHome}>POKEMON TRADER</Title2>
          < SearchBar />
        </LeftSubContainer>
